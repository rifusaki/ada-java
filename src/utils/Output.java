...
public class Output {
    ...
    public static void printAssistanceAwareGrading(double grade, String gradeCategory, double assistanceRate, String outcome) {
        switch (outcome) {
            case "passed" ->
                System.out.println("You passed with a %.2f (%s) and an assistance rate of %.0f%%".formatted(grade, gradeCategory, assistanceRate * 100));
            case "failed_assistance" ->
            ...
            case "failed_grade" ->
                System.out.println("You failed due to a low final grade of %.2f. Your assistance rate was %.0f%%.".formatted(grade, assistanceRate * 100));
            case "failed_both" ->
